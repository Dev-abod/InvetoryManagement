      ...
      <div class="row g-4 mb-5">
        <div class="col-md-6 col-lg-3">
          <div class="card action-card h-100 p-4">
            ...
            <a href="{{ route('operations.create', 'return_out') }}" class="fw-semibold text-primary mt-auto">Start Process</a>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="card action-card h-100 p-4">
            ...
            <a href="{{ route('operations.create', 'return_in') }}" class="fw-semibold text-primary mt-auto">Start Process</a>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="card action-card h-100 p-4">
            ...
            <a href="{{ route('operations.create', 'out') }}" class="fw-semibold text-primary mt-auto">Start Process</a>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="card action-card h-100 p-4">
            ...
            <a href="{{ route('operations.create', 'in') }}" class="fw-semibold text-primary mt-auto">Start Process</a>
          </div>
        </div>
      </div>
